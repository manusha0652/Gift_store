...
<head>
    ...
    * {
    ...
    .cart-item {
        display: grid;
        grid-template-columns: 100px 3fr 1fr 2fr 2fr;
        align-items: center;
        padding: 15px 0;
        border-bottom: 1px solid #eee;
        gap: 25px;
        ...
        <div class="cart-items">
            @if(count($cart_items) > 0)
                ...
                <div class="cart-item">
                    ...
                    <div class="item-price">LKR {{ number_format($item->product->price, 2) }}</div>
                ...
                <script>
                    ...
                    .then(data => {
                        ...
                        item.querySelector('.item-price').innerText.replace('LKR', '').replace(',', '').trim()
                            ...
                            document.querySelector('.summary-value').innerText = `LKR ${subtotal.toFixed(2)}`;
                        
                                const deliveryCharges = 0; // Assuming delivery charges are fixed for now
                            let total = subtotal + deliveryCharges;
                            document.querySelector('.total-value').innerText = `LKR ${total.toFixed(2)}`;
                        } else {
